...
def parse_arguments():
    ...
    parser.add_argument("--years", nargs="+", default=["10y"], help="List of years to consider")
    parser.add_argument("--window_sizes", nargs="+", type=int, default=[5], help="Window sizes")
    parser.add_argument("--train_sizes", nargs="+", type=int, default=[95], help="Training sizes")
    parser.add_argument("--learning_rates", nargs="+", type=float, default=[0.009, 0.01], help="Learning rates")
    # parser.add_argument("--learning_rates", nargs="+", type=float, default=np.linspace(0.009, 0.012, 100), help="Learning rates")
    parser.add_argument("--num_epochs_list", nargs="+", type=int, default=[100], help="Epoch counts")
    parser.add_argument("--batch_sizes", nargs="+", type=int, default=[32], help="Batch sizes")
    parser.add_argument("--prediction_thresholds", nargs="+", type=float, default=[0.4, 0.5], help="Prediction thresholds")
...
def main():
    ...
    p = mp.Process(target=target, kwargs=vars(args))
    p.start()
